...
/// Is the directory entry a hidden path i.e. starts with a period?
///
...
mod tests {
    ...
    fn test_hidden() {
        ...
        assert_eq!(dir_entry_is_hidden(&dir_entry), true);
    }
    ...
    fn test_visible() {
        ...
        assert_eq!(dir_entry_is_hidden(&dir_entry), false);
    }
